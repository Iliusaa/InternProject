...
| T22 | Configure Unity layers, sorting layers, and collision matrix | Coder | pending | MVP-001; Architect decision D02 | Handoff: `Tasks/Open/Coder-Configure-Unity-Layers-Sorting-Collision-Stackspire.md`; must run before Player/Enemy/Projectile/RoomBounds/Exit prefab cards |
