...
### UIUXDesigner
1. `Agents/UIUXDesigner.md` — role knowledge + mobile UI/UX rules
2. `Tasks/Open/[your UI/UX task card]` — the single UI/UX task to design
3. `GDD.md` — source of truth for screens, HUD, and MVP scope
4. `Agents/UIUXDesigner-Memory.md` — previous UI/UX decisions
5. `Core/Conventions.md` — Unity implementation constraints
6. `Agents/ArtDirector.md` — only if creating art asset requests
...
| [[Architect]] | `Tasks/Open/`, [[decisions]] | [[UIUXDesigner]], [[Coder]], [[ArtDirector]] |
| [[UIUXDesigner]] | `Docs/`, `Tasks/Open/` | [[Architect]], [[ArtDirector]], [[Coder]], [[QA]] |
