...
## Purpose
Dash enemy silhouette for lunge timing.

## Gameplay or UI Context
Pause-then-lunge threat. Angular body communicates straight dash without relying on color.
...
## Visual Description
elongated spiky dungeon creature with forward-leaning lunge silhouette and tension pose. Heavy black outline, warped anatomy, dirty stone/bone palette, and grayscale-readable mass. No realistic wound detail.
