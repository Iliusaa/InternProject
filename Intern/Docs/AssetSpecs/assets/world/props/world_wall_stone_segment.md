---
asset_id: world_wall_stone_segment
category: world_prop
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: world_wall_stone_segment

## Purpose
Reusable wall segment prop.
...
|---|---:|---:|---|---|
| default | 192 | 256 | World prop sprite size. | inferred_from_layout |
