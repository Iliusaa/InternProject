---
asset_id: screen_game_hud_room_background
...
# Asset: screen_game_hud_room_background

## Purpose
Game HUD room background.

## Gameplay or UI Context
Full-screen Game HUD visual backing. Unity UI supplies all titles, buttons, values, and labels.
