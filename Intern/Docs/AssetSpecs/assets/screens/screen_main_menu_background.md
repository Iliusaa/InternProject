---
asset_id: screen_main_menu_background
...
# Asset: screen_main_menu_background

## Purpose
Main Menu background.

## Gameplay or UI Context
Full-screen Main Menu visual backing. Unity UI supplies all titles, buttons, values, and labels.
