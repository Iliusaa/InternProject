---
asset_id: screen_class_select_background
...
# Asset: screen_class_select_background

## Purpose
Class Select background.

## Gameplay or UI Context
Full-screen Class Select visual backing. Unity UI supplies all titles, buttons, values, and labels.
