...
# Asset: vfx_damage_particles

## Purpose
Brief stylized damage particles.

## Gameplay or UI Context
Maximum allowed hit particle feedback for player or enemy damage.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 128 | 128 | Reference-canvas VFX cell size. | inferred_from_layout |
