---
asset_id: vfx_warrior_slash_arc
category: vfx
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: vfx_warrior_slash_arc

## Purpose
Warrior melee slash arc VFX.

## Gameplay or UI Context
Short 180-degree melee arc about one character height.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 192 | 128 | Reference-canvas VFX cell size. | inferred_from_layout |
...
## Visual Description
short crescent sword slash arc, bone-white edge with dark crimson scuffed particles. Painterly alpha edges, thick ink breakup, and high contrast. No lingering gore decals or body parts.
