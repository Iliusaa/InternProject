---
asset_id: vfx_room_clear_door_glow
category: vfx
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: vfx_room_clear_door_glow

## Purpose
North exit unlock glow VFX.

## Gameplay or UI Context
Appears over north exit when the last enemy dies.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 320 | 160 | Reference-canvas VFX cell size. | inferred_from_layout |
