...
# Asset: vfx_magic_bolt_trail

## Purpose
Mage bolt trailing glow VFX.

## Gameplay or UI Context
Layered behind Mage bolts to show slow high-damage magic motion.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 128 | 48 | Reference-canvas VFX cell size. | inferred_from_layout |
