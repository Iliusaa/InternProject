...
# Asset: vfx_arrow_streak

## Purpose
Arrow speed streak VFX.

## Gameplay or UI Context
Layered near Archer arrows so fast shots remain readable.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 160 | 24 | Reference-canvas VFX cell size. | inferred_from_layout |
...
## Visual Description
thin torch-gold and bone arrow streak with broken painterly tail. Painterly alpha edges, thick ink breakup, and high contrast. No lingering gore decals or body parts.
