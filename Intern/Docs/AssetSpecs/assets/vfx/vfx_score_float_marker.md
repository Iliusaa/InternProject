---
asset_id: vfx_score_float_marker
category: vfx
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: vfx_score_float_marker

## Purpose
Small backing marker for score float feedback.

## Gameplay or UI Context
Supports enemy kill and room clear score feedback while Unity UI renders +20 or +25 text.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| cell | 96 | 64 | Reference-canvas VFX cell size. | inferred_from_layout |
