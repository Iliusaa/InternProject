...
## Purpose
Readable player class avatar for warrior.

## Gameplay or UI Context
Appears in combat rooms and class selection art. The sword-first silhouette communicates close-range risk/reward.
...
## Visual Description
Tiny vulnerable doll-like adventurer with oversized head, anxious expression, thick black outline, scuffed texture, dark dried-crimson cape, and weapon-first silhouette: oversized chipped sword. Avoid bright damage red except external hit feedback.
