...
## Purpose
Readable player class avatar for mage.

## Gameplay or UI Context
Appears in combat rooms and class selection art. The staff and glow silhouette communicates slower high-damage projectile play.
...
## Visual Description
Tiny vulnerable doll-like adventurer with oversized head, anxious expression, thick black outline, scuffed texture, occult blue-violet hood and small magic glow, and weapon-first silhouette: crooked staff with violet crystal. Avoid bright damage red except external hit feedback.
