...
# Asset: projectile_mage_bolt

## Purpose
Player Mage projectile sprite.

## Gameplay or UI Context
Straight magic bolt that supports penetration until wall after the Mage special upgrade.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| default | 96 | 48 | Reference-canvas projectile sprite size. | inferred_from_layout |
...
## Visual Description
occult blue-violet magic bolt with ragged comet silhouette and bone-white core. Thick ink edge, clear travel direction, high contrast against dark stone, and no readable markings.
