---
asset_id: projectile_archer_arrow
category: projectile
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: projectile_archer_arrow

## Purpose
Player Archer projectile sprite.

## Gameplay or UI Context
Fast straight ranged damage from right-stick aim.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| default | 128 | 32 | Reference-canvas projectile sprite size. | inferred_from_layout |
...
## Visual Description
chipped wooden arrow with bone arrowhead and small torch-gold streak accent. Thick ink edge, clear travel direction, high contrast against dark stone, and no readable markings.
