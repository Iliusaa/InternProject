---
asset_id: ui_game_over_stat_panel
category: ui_menu
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_game_over_stat_panel

## Purpose
Game Over stat panel backing.
...
|---|---:|---:|---|---|
| normal | 780 | 495 | Primary display or state cell size. | Docs/UIUX_MVP_SPEC.md |
| new_high_score | 780 | 495 | Additional state cell size. | Docs/UIUX_MVP_SPEC.md |
...
## Visual Description
780x495 game over result stat panel with empty row sockets and no text. Chipped stone, bone/parchment detail, thick ink outline, scuffed texture, and no baked labels.
