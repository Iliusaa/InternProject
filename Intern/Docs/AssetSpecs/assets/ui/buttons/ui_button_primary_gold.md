---
asset_id: ui_button_primary_gold
category: ui_button
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_button_primary_gold

## Purpose
Primary action button art for Start Run, Restart, and high-priority actions.
...
|---|---:|---:|---|---|
| default | 660 | 96 | State cell size. | Docs/UIUX_MVP_SPEC.md |
| pressed | 660 | 96 | State cell size. | Docs/UIUX_MVP_SPEC.md |
| disabled | 660 | 96 | State cell size. | Docs/UIUX_MVP_SPEC.md |
...
## Visual Description
dominant torch-gold chipped stone button slab with dark ink bevel and bone highlight. Chipped fantasy stone UI with thick outline, scuffed fill, and tactile raised/pressed/disabled treatment.
