...
# Asset: ui_button_icon_stone

## Purpose
Reusable icon button backing for pause, back, and settings icons.
...
|---|---:|---:|---|---|
| default | 72 | 72 | State cell size. | Docs/UIUX_MVP_SPEC.md |
| pressed | 72 | 72 | State cell size. | Docs/UIUX_MVP_SPEC.md |
| disabled | 72 | 72 | State cell size. | Docs/UIUX_MVP_SPEC.md |
...
## Visual Description
small chipped stone circular or rounded-square icon button backing. Chipped fantasy stone UI with thick outline, scuffed fill, and tactile raised/pressed/disabled treatment.
