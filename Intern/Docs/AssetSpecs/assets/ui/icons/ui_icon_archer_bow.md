...
# Asset: ui_icon_archer_bow

## Purpose
Archer class weapon icon.
...
## Visual Description
curved bow and arrow silhouette with sickly green wrap. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
