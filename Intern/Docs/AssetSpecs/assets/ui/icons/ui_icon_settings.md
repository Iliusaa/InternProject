...
# Asset: ui_icon_settings

## Purpose
Optional settings icon mark.

## Gameplay or UI Context
Used as a reusable UI icon on Main Menu. It must communicate meaning at small size without relying on text.
...
## Visual Description
uneven cog made of stone and bone, no letters. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
