---
asset_id: ui_icon_upgrade_greed
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
## Visual Description
coin cluster and hooked claw motif, no text. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 56-64 px.
