---
asset_id: ui_icon_upgrade_warrior_special
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_upgrade_warrior_special

## Purpose
Warrior special armor hit icon.
...
## Visual Description
small armor shield with sword notch and dark crimson accent. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 56-64 px.
