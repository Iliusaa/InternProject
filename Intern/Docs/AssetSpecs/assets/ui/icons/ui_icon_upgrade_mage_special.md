---
asset_id: ui_icon_upgrade_mage_special
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_upgrade_mage_special

## Purpose
Mage penetration icon.
...
## Visual Description
magic bolt passing through two dark silhouettes with blue-violet accent. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 56-64 px.
