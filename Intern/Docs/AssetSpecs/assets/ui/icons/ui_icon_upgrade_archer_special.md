---
asset_id: ui_icon_upgrade_archer_special
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_upgrade_archer_special

## Purpose
Archer double-shot icon.
...
## Visual Description
two staggered arrows in same direction with sickly green accent. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 56-64 px.
