...
# Asset: ui_icon_mage_staff

## Purpose
Mage class weapon icon.
...
## Visual Description
crooked staff with occult blue-violet crystal. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
