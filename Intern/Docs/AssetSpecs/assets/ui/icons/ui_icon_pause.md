...
## Purpose
Pause icon mark for icon button.
...
## Visual Description
two vertical bone bars inside a chipped stone style. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
