---
asset_id: ui_icon_warrior_sword
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_warrior_sword

## Purpose
Warrior class weapon icon.

## Gameplay or UI Context
Used as a reusable UI icon on Class Select, Upgrade Menu. It must communicate meaning at small size without relying on text.
...
## Visual Description
oversized chipped sword silhouette with crimson cloth wrap. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
