---
asset_id: ui_icon_heart_armor_pip
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_heart_armor_pip

## Purpose
Warrior armor pip displayed before hearts.

## Gameplay or UI Context
Used as a reusable UI icon on Game HUD. It must communicate meaning at small size without relying on text.

## Pixel Dimensions
| Variant or State | Width px | Height px | Notes | Source |
|---|---:|---:|---|---|
| default | 48 | 48 | Icon source size. | Docs/UIUX_MVP_SPEC.md |
...
## Visual Description
small silver bone-shield pip with black outline. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
