---
asset_id: ui_icon_upgrade_agility
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_upgrade_agility

## Purpose
Agility upgrade icon.
...
## Visual Description
boot or quick-step claw mark motif, no text. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 56-64 px.
