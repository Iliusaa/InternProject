---
asset_id: ui_icon_heart_damage_flash
category: ui_icon
source_files:
  - STATUS.md
  - CONTEXT.md
...
# Asset: ui_icon_heart_damage_flash

## Purpose
Heart damage flash replacement or overlay.
...
## Visual Description
heart flash shape using damage red edge and transparent center. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
