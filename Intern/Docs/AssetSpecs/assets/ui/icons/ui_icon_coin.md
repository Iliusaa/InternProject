...
## Purpose
Coin icon for currency chips and reward emphasis.

## Gameplay or UI Context
Used as a reusable UI icon on Game HUD, Upgrade Menu, Game Over. It must communicate meaning at small size without relying on text.
...
## Visual Description
round chipped gold coin with tiny original skull mark shape but no readable symbol. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
