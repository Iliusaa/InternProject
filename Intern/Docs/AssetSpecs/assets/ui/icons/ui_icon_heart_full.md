...
# Asset: ui_icon_heart_full

## Purpose
Full health heart icon.
...
## Visual Description
red filled heart with black ink outline and bone highlight. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
