...
# Asset: ui_icon_heart_empty

## Purpose
Empty health heart icon.
...
## Visual Description
dark broken heart outline with hollow center. Thick black outline, high value contrast, scuffed texture, and clean silhouette. Keep icon simple enough to read at 48-64 px.
