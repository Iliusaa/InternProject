---
asset_id: ui_door_indicator_unlocked
...
# Asset: ui_door_indicator_unlocked

## Purpose
Unlocked north exit indicator.
...
|---|---:|---:|---|---|
| unlocked | 128 | 128 | Feedback asset size. | inferred_from_layout |
