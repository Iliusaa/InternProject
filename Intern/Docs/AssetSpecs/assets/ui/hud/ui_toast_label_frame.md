...
# Asset: ui_toast_label_frame

## Purpose
Reusable toast label frame for short feedback.
...
|---|---:|---:|---|---|
| room_clear | 500 | 80 | Primary display or state cell size. | inferred_from_layout |
| exit_locked | 500 | 80 | Additional state cell size. | inferred_from_layout |
| damage_warning | 500 | 80 | Additional state cell size. | inferred_from_layout |
