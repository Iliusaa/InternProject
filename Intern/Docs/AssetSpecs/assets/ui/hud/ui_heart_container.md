...
# Asset: ui_heart_container

## Purpose
HUD heart row container and spacing reference.
...
|---|---:|---:|---|---|
| default | 398 | 104 | Primary display or state cell size. | Docs/UIUX_MVP_SPEC.md |
| wrap_reference | 398 | 104 | Additional state cell size. | Docs/UIUX_MVP_SPEC.md |
