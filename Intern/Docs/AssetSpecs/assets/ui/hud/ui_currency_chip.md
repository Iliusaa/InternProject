...
# Asset: ui_currency_chip

## Purpose
Current-run coin chip backing.
...
|---|---:|---:|---|---|
| default | 260 | 64 | Primary display or state cell size. | inferred_from_layout |
| updated_pulse_highlight | 260 | 64 | Additional state cell size. | inferred_from_layout |
