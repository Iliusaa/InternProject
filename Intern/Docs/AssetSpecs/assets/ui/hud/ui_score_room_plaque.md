...
# Asset: ui_score_room_plaque

## Purpose
HUD backing for Score and Room text.
...
|---|---:|---:|---|---|
| default | 480 | 104 | Primary display or state cell size. | Docs/UIUX_MVP_SPEC.md |
| update_pulse | 480 | 104 | Additional state cell size. | Docs/UIUX_MVP_SPEC.md |
